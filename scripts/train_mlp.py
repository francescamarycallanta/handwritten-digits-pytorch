"""
Train the MLP model from the command line.
Run: python scripts/train_mlp.py --epochs 30
"""
...
def main():
    ...
    set_seed(args.seed) # make results repeatable
    device = get_device()
    ...
    model = MNISTMLP(dropout_p=args.dropout).to(device)
